...
a.val())):!1!==e?(null!==c.oldAjax&&c.oldAjax.abort(),c.ajaxTimer.timer({delay:c.ajaxRefreshInterval,autoStart:!0}).on("complete.timer",function(){c.oldAjax=d.ajax({url:e,dataType:"json",cache:!1,type:"post",data:{jquery_validate:f},success:function(a){b.removeClass("validator-loading");h(a);a.oldAjax=null},error:function(a){"abort"!==a.statusText&&(b.removeClass("validator-loading"),h(!1));c.oldAjax=null}})}),b.addClass("validator-loading")):(a.lastIndex=0,h(a.test(f)));b.data("validator",c)}},g=
{init:function(a){return this.each(function(){var b=d(this),c=b.data("validator");if(b.is('input[type="text"], input[type="password"], textarea')){c||(c={settings:{mask:"required",predefinedMasks:{email:/^(([^<>()[\]\\.,;:\s@\"]+(\.[^<>()[\]\\.,;:\s@\"]+)*)|(\".+\"))@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\])|(([a-zA-Z\-0-9]+\.)+[a-zA-Z]{2,}))$/,required:/^.+$/gm,zip_code_ger_and_at:/^\d{4,5}$/,no_white_space:/^\w+$/g,number:/^\d+((?:\.\d{0,})?(?:\,\d{0,})?)$/,integer:/^\d+$/,date_day_month_year:/^\d{1,2}\.\d{1,2}\.(\d{2}|\d{4})$/,
date_year_month_day:/^\d{4}-\d{2}-\d{2}$/},ajax:!1,ajaxRefreshInterval:2E3,optional:!1,liveCheck:!1,rel:!1},mask:null,valid:!1,disabled:!1,ajaxTimer:d({}),oldValue:void 0,oldAjax:null});b.addClass("validator");d.extend(!0,c.settings,a);c.mask="string"===typeof c.settings.mask?c.settings.predefinedMasks[c.settings.mask]?c.settings.predefinedMasks[c.settings.mask]:RegExp(c.settings.mask):c.settings.mask;b.data("validator",c);b.off(".validator");if(!0===c.settings.liveCheck)b.on("keydown.validator keyup.validator keypress.validator change.validator blur.validator",
i);else b.on("change.validator blur.validator",i);b.trigger("change.validator");if(c.settings.rel)d(c.settings.rel).on("checkedvalue.validator",function(){b.trigger("change.validator")})}})},destroy:function(){return this.each(function(){var a=d(this);a.data("validator")!==e&&(a.off(".validator"),a.removeData("validator").removeClass("validator validator-invalid"))})},disable:function(){return this.each(function(){var a=d(this),b=a.data("validator");b!==e&&(b.disabled=!0,a.data("validator",b),a.trigger("change.validator"))})},
enable:function(){return this.each(function(){var a=d(this),b=a.data("validator");b!==e&&(b.disabled=!1,a.data("validator",b),a.trigger("change.validator"))})},valid:function(){var a=!0;d(this).each(function(){var b=d(this).data("validator");if(b!==e&&!1===b.valid)return a=!1});return a}};d.fn.validator=function(a){if(g[a])return g[a].apply(this,Array.prototype.slice.call(arguments,1));if("object"===typeof a||!a)return g.init.apply(this,arguments);d.error("Method "+a+" does not exist on jQuery.vaidator")}})(jQuery);
